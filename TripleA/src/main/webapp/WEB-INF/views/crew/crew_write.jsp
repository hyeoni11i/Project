...
<body>
    ...
    <section>
        ...
        <div class="wrap">
<!-- form---------------------------------------------------------------------------------------------------------------------------------->
            <form action="./crew_insert" id="crew_write_id" method="post" enctype="multipart/form-data">
                <div class="main1">
                    <input type="hidden" id="c_expose" name="c_expose">
                    <div class="chart">
                    <span style="color: red; margin-top: 20px;">아래 내용을 빠짐없이 입력해 주세요</span>
                        <table>
                            <tr>
                                <td class="info"><span class="material-icons">title</span> 제목</td>
                                <td colspan="3"><input id="c_title" name="c_title" type="text" style="width: 600px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">category</span> 크루종류</td>
                                <td>
                                <input type="hidden" value="${session_u_no}" name="u_no">
                            ...
                            <tr>
                                ...
                                <td><input id="c_apply_sdate" name="c_apply_sdate" type="date" style="width: 150px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                                
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">flag</span> 신청종료일</td>
                                <td><input id="c_apply_edate" name="c_apply_edate" type="date" style="width: 150px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                                
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">today</span> 시작일</td>
                                <td><input id="c_sdate" name="c_sdate" type="date" style="width: 150px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                                
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">event</span> 종료일</td>
                                <td><input id="c_edate" name="c_edate" type="date" style="width: 150px; height: 30px; font-size: 18px;" spellcheck="false"></td>
...
/* 주소API------------------------------------------------------------------------ */
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="addr1" name="c_addr1" placeholder="주소" style="width: 350px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                                <td><button type="button" onclick="zipSearch()" style="font-size: 18px;" class="mod_form_btn">우편 번호 검색</button></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="3"><input type="text" id="addr2" name="c_addr2" placeholder="상세주소" style="width: 600px; height: 30px; font-size: 18px;" spellcheck="false"></td>
                            </tr>
<script>
/* 셀렉트박스------------------------------------------------------------------------ */
    $(function(){
...
/* 셀렉트박스------------------------------------------------------------------------ */
                            ...
                            <tr>
                                ...
                                <td><input type="number" id="c_cost" name="c_cost"  min="0" value="0" style="width: 100px; height: 30px; font-size: 18px;" readonly spellcheck="false">원</td>
                            ...
                            <tr>
                                ...
                                <td><input type="number" id="c_count" name="c_count" min="1" value="00" style="width: 100px; height: 30px; font-size: 18px;" readonly spellcheck="false">명</td>
                                
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">upload_file</span>파일첨부</td>
                                <td style="width: 200px;"><input type="file" name="file1" id="file1"></td>
                            </tr>
                            <tr>
                                <td class="info"><span class="material-icons">upload_file</span>썸네일</td>
                                <td style="width: 200px;"><input type="file" name="file2" id="file2"></td>
                            </tr>
                        </table>
                        ...
                        <div style="margin-bottom: 300px;">
                            <textarea id="summernote" name="c_content" rows="100" cols="100" spellcheck="false"></textarea>
                        </div>
